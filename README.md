...
> 🔍 **在线看产物**（无需安装）：[落地页](https://wangliquan.github.io/specforge/) · [spec.html 示例](https://wangliquan.github.io/specforge/showcase.html) · [report.html 示例](https://wangliquan.github.io/specforge/showcase.report.html)
...
先打开 **[在线 spec 示例](https://wangliquan.github.io/specforge/showcase.html)** 看一份真实生成出的 spec 长什么样（再看 [report 示例](https://wangliquan.github.io/specforge/showcase.report.html)）。
