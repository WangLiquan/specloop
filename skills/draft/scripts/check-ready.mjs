...
var unready = assumptions.filter((a) => effectiveVerified(a) !== true);
if (unready.length) {
  console.error(
    `\u672A\u5C31\u7EEA\uFF1A${unready.length}/${assumptions.length} \u6761\u73B0\u72B6\u5047\u8BBE\u672A\u901A\u8FC7\u6838\u9A8C\uFF08\u672A\u6838 / \u4E0D\u7B26 / claim\xB7evidence \u6539\u52A8\u81F4\u6307\u7EB9\u5931\u6548\u9700\u91CD\u6838\uFF09\uFF1A
` + unready.map((a) => {
      const ev = effectiveVerified(a);
      const why = ev === false ? "\u4E0D\u7B26" : a.verifiedDigest == null ? "\u672A\u6838" : "\u5DF2\u6539\u52A8\xB7\u9700\u91CD\u6838";
